    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-20">
            ...
            <div class="hidden md:flex items-center gap-3">
                <a href="{{ route('vendor.login') }}" class="text-sm font-semibold text-green-600 hover:text-green-700 px-4 py-2 border border-green-600 rounded-xl transition">Client Login</a>
                <a href="/contact" class="btn-primary text-sm">Become a Client</a>
            </div>
        ...
        <div x-show="menuOpen" x-transition class="md:hidden py-4 border-t" style="display:none">
            <div class="flex flex-col gap-3">
                ...
                <a href="{{ route('vendor.login') }}" class="btn-secondary text-sm text-center">Client Login</a>
                <a href="/contact" class="btn-primary text-sm text-center">Become a Client</a>
            </div>
        </div>
    </div>
</header>
